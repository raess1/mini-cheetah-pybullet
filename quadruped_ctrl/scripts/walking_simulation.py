...
#"/home/quadruped/cheetah_ws/src/yobo_model/yobotics_description/urdf/yobotics.urdf"
    ...
    # stairs
   # colSphereId = p.createCollisionShape(p.GEOM_BOX, halfExtents=[0.1, 2, 0.04])
   # colSphereId1 = p.createCollisionShape(p.GEOM_BOX, halfExtents=[0.1, 2, 0.08])
   #colSphereId2 = p.createCollisionShape(p.GEOM_BOX, halfExtents=[0.1, 2, 0.12])
   # colSphereId3 = p.createCollisionShape(p.GEOM_BOX, halfExtents=[0.1, 2, 0.16])
   #colSphereId4 = p.createCollisionShape(p.GEOM_BOX, halfExtents=[1.0, 2, 0.20])
   # BoxId = p.createMultiBody(100, colSphereId, basePosition=[1.0, 0.0, 0.0])
   # BoxId = p.createMultiBody(100, colSphereId1, basePosition=[1.2, 0.0, 0.0])
    #BoxId = p.createMultiBody(100, colSphereId2, basePosition=[1.4, 0.0, 0.0])
   # BoxId = p.createMultiBody(100, colSphereId3, basePosition=[1.6, 0.0, 0.0])
   # BoxId = p.createMultiBody(100, colSphereId4, basePosition=[2.7, 0.0, 0.0])
